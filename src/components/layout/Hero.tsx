  ...
  return (
    <section className="relative min-h-[100svh] w-full overflow-hidden bg-bg-base pt-32 pb-16 md:pt-40 lg:pt-48 lg:pb-24 flex items-center">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[20%] -left-[10%] h-[50%] w-[30%] rounded-full bg-accent-50/60 blur-[100px]" />
        ...
        <div className="flex flex-col gap-16 lg:flex-row lg:items-center lg:gap-8">
          ...
          <div className="flex flex-col items-start lg:w-[55%]">
            <motion.div
              ...
              className="inline-flex items-center rounded-full border border-gray-200 bg-white px-3 py-1 text-sm font-medium text-gray-600 mb-6 shadow-sm"
            >
            ...
            <motion.h1
              ...
              className="text-5xl font-bold tracking-tight text-gray-900 md:text-6xl lg:text-[4.5rem] lg:leading-[1.1] font-heading mb-6"
            >
            ...
            >
              <Button size="lg" className="w-full sm:w-auto px-8 h-14 text-base group">
                Get Started
            ...
            <motion.div
              ...
              className="grid grid-cols-2 gap-y-3 gap-x-6 w-full"
            >
          ...
          <div className="lg:w-[45%] relative mt-8 lg:mt-0">
            ...
            >
              {/* Decorative shapes */}
              <div className="absolute -inset-4 bg-gradient-to-tr from-brand-100 to-accent-50 rounded-[2.5rem] transform rotate-3 scale-105 opacity-50 blur-lg transition-transform duration-700 hover:rotate-6" />
              
              {/* Main Image Container */}
              <div className="relative rounded-[2rem] overflow-hidden border border-gray-100 bg-white p-2 shadow-2xl shadow-brand-900/5 aspect-[4/5] lg:aspect-[3/4]">
                <img 
                ...
                <motion.div 
                  ...
                  className="absolute bottom-8 -left-6 lg:-left-12 rounded-2xl bg-white p-4 shadow-xl border border-gray-100 flex items-center gap-4"
                >
                  <div className="flex h-12 w-12 items-center justify-center rounded-full bg-brand-50 text-brand-700">
                    <ArrowRight className="h-5 w-5 -rotate-45" />
                  </div>
                  <div>
                    <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Growth</p>
                    <p className="text-lg font-bold text-gray-900 font-heading">+240% ROI</p>
                  </div>
                </motion.div>
                ...
                <motion.div 
                  ...
                  className="absolute top-12 -right-6 lg:-right-8 rounded-2xl bg-white p-4 shadow-xl border border-gray-100 flex flex-col gap-2"
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div className="h-8 w-8 rounded-full border-2 border-white bg-brand-50 flex items-center justify-center">
                      <span className="text-xs font-bold text-brand-700">+</span>
                    </div>
                  </div>
                  <p className="text-xs font-medium text-gray-600">Expert Campaign Team</p>
                </motion.div>
