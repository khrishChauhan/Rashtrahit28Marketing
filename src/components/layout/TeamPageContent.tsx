...
function TeamMemberCard({ member }: { member: any, key?: number | string }) {
  return (
    <motion.div
      ...
      className="group relative flex h-full cursor-pointer flex-col items-center rounded-[2rem] border border-gray-100 bg-white p-8 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-brand-200 hover:shadow-xl hover:shadow-brand-900/5"
    >
      <div className="relative mb-6 h-32 w-32 shrink-0 overflow-hidden rounded-full border border-gray-50 bg-gray-100 shadow-sm">
        <img
          src={member.image}
          alt={member.name}
      ...
      <h3 className="mb-2 text-xl font-bold text-gray-900 font-heading transition-colors duration-300 group-hover:text-brand-700 text-center">
        {member.name}
      </h3>
      <p className="text-sm font-semibold text-brand-600 text-center">
        {member.role}
      </p>
    </motion.div>
  );
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <section className="mb-24 md:mb-32">
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
            className="group relative mx-auto flex max-w-2xl cursor-pointer flex-col items-center rounded-[2.5rem] border border-gray-100 bg-white p-10 md:p-16 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-brand-200 hover:shadow-xl hover:shadow-brand-900/5"
          >
            <div className="relative mb-8 flex h-40 w-40 items-center justify-center rounded-full border border-brand-100 bg-brand-50/50 shadow-inner transition-transform duration-500 group-hover:scale-105 group-hover:bg-brand-50">
              <span className="font-heading text-5xl font-bold tracking-wider text-brand-700">
                AJ
              </span>
            </div>
            <h3 className="mb-3 font-heading text-3xl font-bold text-gray-900 transition-colors duration-300 group-hover:text-brand-700 text-center">
              Abhishek Jha
            </h3>
            <p className="mb-6 text-xl font-semibold text-brand-600 text-center">
              Director
            </p>
            <p className="text-center text-lg leading-relaxed text-gray-600 max-w-md">
        ...
        <section className="mb-24 md:mb-32">
          ...
          <div className="mx-auto grid max-w-3xl gap-6 md:gap-8 grid-cols-1 sm:grid-cols-2">
