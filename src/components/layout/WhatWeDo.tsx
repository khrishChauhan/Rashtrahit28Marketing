...
export function WhatWeDo() {
  return (
    <section className="relative overflow-hidden bg-gray-50/30 py-24 md:py-32">
      {/* Subtle Background Elements */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/2 -left-[10%] h-[500px] w-[500px] -translate-y-1/2 rounded-full bg-brand-50/60 blur-[100px]" />
        <div className="absolute bottom-0 right-[10%] h-[300px] w-[300px] rounded-full bg-accent-50/40 blur-[80px]" />
      </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-12">
          ...
          <div className="flex flex-col items-start lg:w-[35%] lg:pr-8">
            ...
            >
              ...
              <h2 className="mb-6 text-5xl font-bold tracking-tight text-gray-900 md:text-6xl lg:text-[4rem] lg:leading-[1.1] font-heading">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:gap-8">
              {SERVICES.map((service, idx) => (
                <motion.div
                  ...
                  className="group relative flex flex-col rounded-3xl border border-gray-100 bg-white p-8 shadow-sm transition-all duration-500 hover:-translate-y-2 hover:border-brand-300 hover:shadow-xl hover:shadow-brand-900/5 lg:p-10"
                >
                  <div className="mb-8 flex h-14 w-14 items-center justify-center rounded-2xl bg-brand-50 text-brand-700 transition-colors duration-500 group-hover:bg-brand-600 group-hover:text-white">
                    {service.icon}
                  </div>
                  ...
                  <a 
                    href="#" 
                    className="mt-auto inline-flex items-center text-sm font-semibold text-brand-700"
                  >
